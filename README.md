...
- **Advanced Link Support**: If you copy a hyperlink from the page by highlighting it, it smartly grabs the underlying `href` URL so you don't just get useless plain text. 
...
> **Note:** After installing or updating the code, you **must refresh** (`F5`) any already-opened web pages for the extension script to become active.
